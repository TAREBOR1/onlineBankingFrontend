...
const navItems = [
  ...
  { name: "Deposit Request", href: "/admin/deposit", icon: Wallet },
  { name: "Card Request", href: "/admin/card", icon: CreditCard },
  { name: "Crypto Wallet", href: "/admin/crypto", icon: CreditCard },
  { name: "Transactions", href: "/admin/transactions", icon: History },
  { name: "Notifications", href: "/admin/notifications", icon: Bell },
  { name: "KYC submission", href: "/admin/kyc", icon: Shield },
];
        ...
        <div className="flex h-full flex-col p-6 overflow-hidden">
          ...
          <div className="flex-none mb-8 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-black tracking-tighter dark:text-white">Admin Panel</span>
            </div>
          ...
          <div className="flex-none mt-6 pt-6 border-t border-slate-100 dark:border-white/5 space-y-4">
            ...
            <Link href="/dashboard/profile" onClick={() => window.innerWidth < 768 && closeSidebar()}>
              <div className="flex items-center gap-3 p-2 rounded-2xl hover:bg-slate-100 dark:hover:bg-white/5 transition-colors cursor-pointer group">
                <div className="h-10 w-10 border-2 border-white dark:border-slate-800 shadow-sm rounded-full bg-slate-200 dark:bg-slate-800 flex items-center justify-center font-black text-xs shrink-0">JD</div>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-black dark:text-white leading-none truncate">John Doe</p>
            ...
            <Button variant="ghost" className="w-full justify-start gap-4 px-3 text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 font-bold rounded-xl h-12">
                <LogOut size={18} />
                <span>Sign Out</span>
            </Button>
          </div>
