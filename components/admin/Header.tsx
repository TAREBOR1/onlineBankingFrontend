...
import { Menu, Moon, Sun, ChevronDown ,Bell, Inbox } from "lucide-react";
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex md:flex-1">
          {/* <div className="relative w-96">
            ...
            <Input
              placeholder="Search transactions, cards, or users..."
      ...
      <DropdownMenuContent align="end" className="w-80 rounded-2xl p-0 shadow-2xl border-slate-200 dark:border-slate-800 bg-white dark:bg-[#111113]">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56 rounded-xl">
            ...
            <Separator />
            <DropdownMenuItem onClick={()=>{logout.mutate()}} className="cursor-pointer text-red-600">Logout</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
    </header>
